...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0">Cek Validasi e-PA</h4>
    ...
    <div class="card">
      <div class="card-body">
        <form class="" action="<?= site_url('verifikasi/save')?>" method="post">
          <div class="row mb-3">
              <div class="col-lg-3">
                  <label for="nameInput" class="form-label">NIPA</label>
              </div>
              <div class="col-lg-9">
                  <input type="text" class="form-control" id="nameInput" value="<?= $pegawai->nipa?>" readonly>
              </div>
          </div>
          <div class="row mb-3">
              <div class="col-lg-3">
          ...
          <div class="row mb-3">
              ...
              <div class="col-lg-9">
                  <input type="text" class="form-control" id="nameInput" value="<?= $pegawai->provinsi?>" readonly>
              </div>
          </div>
          <div class="row mb-3">
              <div class="col-lg-3">
                  <label for="nameInput" class="form-label">KABUPATEN</label>
              </div>
              <div class="col-lg-9">
                  <input type="text" class="form-control" id="nameInput" value="<?= $pegawai->kabupaten?>" readonly>
              </div>
          </div>
        </form>
      </div>
