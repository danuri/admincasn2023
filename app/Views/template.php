            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="https://d2mj1s7x3czrue.cloudfront.net/hrms/assets/images/logo-hrms.png" alt="" height="40"> Admin CASN 2023
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-13 text-muted user-name-sub-text"><?= session('satker4')?></span>
                            </span>
                        </span>
                    </button>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('formasi')?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('regulasi')?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= site_url('upload')?>">
